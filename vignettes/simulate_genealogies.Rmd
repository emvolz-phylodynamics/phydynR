...
fontsize: 12pt
vignette: >
  %\VignetteIndexEntry{Simulating genealogies with an epidemiological coalescent model using phydynR}
...
show.demographic.process(demo.model, theta, x0, t0, t1, legend_position = "topright")
```
