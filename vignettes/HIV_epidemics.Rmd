...
as follows and is also illustrated in Figure 1:
...
#colnames(data_list)<-c("Parameter","Symbol", "Values")


kbl(data_list, booktabs = T, caption = "Parameter symbols and values") %>%
...
sampleStatesAnnotations. Alternatively, that information can be passed as a
...
time, which is shown in figure 2
